...
import com.wvs.shoppercrux.adapters.CategoryDrawerAdapter;
import com.wvs.shoppercrux.classes.CatDrawerItem;
import com.wvs.shoppercrux.classes.Category;
import com.wvs.shoppercrux.classes.CategoryFetch;
 ...
 */
public class CategoryDrawer extends Fragment {
    ...
    public static List<CatDrawerItem> getData() {
        List<CatDrawerItem> data = new ArrayList<>();


        // preparing navigation drawer items
        for (int i = 0; i < titles.length; i++) {
            CatDrawerItem navItem = new CatDrawerItem();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = (RecyclerView) layout.findViewById(R.id.categoryList);

        CategoryFetch displayCategory=new CategoryFetch(getContext());
        arrayList = displayCategory.getCategory();
