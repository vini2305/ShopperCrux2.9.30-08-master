...
//    public static final String URL_VERIFY_OTP = "http://shoppercrux.com/shopper_android_api/verify_otp.php";
    ...
    public static final String URL_CATEGORY="http://shoppercrux.com/shopper_android_api/category.php";

    public static String URL_FORGOT_PASSWORD="http://shoppercrux.com/shopper_android_api/forgot.php";

    public static String URL_GOOGLE_USER="http://shoppercrux.com/shopper_android_api/gplus.php";

    public static final String URL_RESET_PASSWORD="http://shoppercrux.com/shopper_android_api/resetpassword.php";

    public static final String URL_USER_VERIFY="http://shoppercrux.com/shopper_android_api/userverify.php";
